...
void rewind_lexeme();
// pre-condition : la séquence de caractères est accessible
// repositionne le curseur de lecture au début du fichier
// réinitialise le numéro de ligne et de colonne à leur valeur initiale
// post-condition : le caractère courant est mis à jour (avancer_car)
